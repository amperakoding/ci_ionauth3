...
class Auth extends CI_Controller
{
	...
	public function forgot_password()
	{
		...
		if ($this->form_validation->run() === FALSE) {
			...
			if (empty($identity)) {
				...
				$this->session->set_flashdata('message', $this->ion_auth->errors());
				redirect("admin/admin/auth/forgot_password", 'refresh');
			}
			...
			if ($forgotten) {
				...
				$this->session->set_flashdata('message', $this->ion_auth->messages());
				redirect("admin/admin/auth/login", 'refresh'); //we should display a confirmation page here instead of the login page
			} else {
				$this->session->set_flashdata('message', $this->ion_auth->errors());
				redirect("admin/admin/auth/forgot_password", 'refresh');
			}
			...
			if ($this->form_validation->run() === FALSE) {
				...
				if ($this->_valid_csrf_nonce() === FALSE || $user->id != $this->input->post('user_id')) {
					...
					if ($change) {
						// if the password was successfully changed
						$this->session->set_flashdata('message', $this->ion_auth->messages());
						redirect("admin/admin/auth/login", 'refresh');
					} else {
						$this->session->set_flashdata('message', $this->ion_auth->errors());
	...
	public function create_user()
	{
		...
		$this->form_validation->set_rules('address', $this->lang->line('create_user_validation_address_label'), 'required|trim');
	...
	public function edit_user($id)
	{
		...
		$this->form_validation->set_rules('address', $this->lang->line('edit_user_validation_address_label'), 'required|trim');
		$this->form_validation->set_rules('username', $this->lang->line('edit_user_validation_identity_label'), 'required|trim');
